...
export async function connectDB() {
  ...
  if (!cached.promise) {
    ...
    const opts = {
      ...
      maxPoolSize: 5, // Reduced for serverless (functions are ephemeral)
      minPoolSize: 1, // Keep at least 1 connection ready
      serverSelectionTimeoutMS: 3000, // Faster timeout for Vercel (3 seconds)
      socketTimeoutMS: 30000, // Reduced for serverless (30 seconds)
      connectTimeoutMS: 3000, // Fast connection timeout
      retryWrites: true,
      retryReads: true,
      // Optimize for serverless: don't wait for connection to be fully ready
      // The connection will be ready when needed
