...
export const PERMISSION_MODULES = [
  ...
  { key: 'breakMonitoring', label: 'Break Monitoring', actions: ['view', 'create', 'update', 'delete', 'export'] },
...
export const PERMISSION_PRESETS = {
  ...
  attendance_officer: {
    ...
    build: () => {
      ...
      p.breakMonitoring = { view: true, create: true, update: true, delete: true, export: true };
  ...
  hr_assistant: {
    ...
    build: () => {
      ...
      p.breakMonitoring = { view: true, create: true, update: true, delete: true, export: false };
      p.monthlyAttendance = { view: true, update: false };
